...
ax1.set_xticklabels(['0.1', '0.3', '0.5', '0.7', '0.9'], fontsize=16)
ax1.tick_params(axis='x', pad=2)  # 调整 y 轴刻度标签与轴的距离

ax1.set_yticks(np.arange(data.shape[0]) + 0.7)
ax1.set_yticklabels(['Cora', 'Weibo', 'Reddit'], fontsize=18,  rotation=10 )
ax1.tick_params(axis='y', pad=1)  # 调整 y 轴刻度标签与轴的距离

ax1.set_xlabel(f'$\epsilon$', fontsize=20, labelpad=8)  # Adjust x-axis label distance
ax1.set_ylabel('Datasets', fontsize=18, labelpad=12)  # Adjust y-axis label distance
...
ax2.set_xticklabels(['0.1', '0.3', '0.5', '0.7', '0.9'], fontsize=16)
ax2.set_yticks(np.arange(data.shape[0]) + 0.7)
ax2.set_yticklabels(['Disney', 'Books', 'Enron'], fontsize=18, rotation=10)
...
ax2.set_ylabel('Datasets', fontsize=18, labelpad=12)  # Adjust y-axis label distance
ax2.set_zlabel('Score', fontsize=18, labelpad=10)  # Adjust z-axis label distance
ax2.set_zlim(0., 0.75)
...
# ax3.set_xticklabels(['1', '5', '10', '15', '20'], fontsize=18)
# ax3.set_yticks(np.arange(data.shape[0]) + 0.7)
# ax3.set_yticklabels(['F1', 'NMI', 'ARI', 'ACC'], fontsize=18)
# ax3.set_xlabel('k (%)', fontsize=18, labelpad=12)  # Adjust x-axis label distance
# ax3.set_ylabel('Metrics', fontsize=18, labelpad=12)  # Adjust y-axis label distance
# ax3.set_zlabel('Score', fontsize=18, labelpad=12)  # Adjust z-axis label distance
# ax3.set_zlim(0, 0.75)
...
# ax4.set_xticks(np.arange(data.shape[1]) + 0.5)
# ax4.set_xticklabels(['1', '5', '10', '15', '20'], fontsize=18)
# ax4.set_yticks(np.arange(data.shape[0]) + 0.7)
# ax4.set_yticklabels(['F1', 'NMI', 'ARI', 'ACC'], fontsize=18)
# ax4.set_xlabel('k (%)', fontsize=18, labelpad=12)  # Adjust x-axis label distance
# ax4.set_ylabel('Metrics', fontsize=18, labelpad=12)  # Adjust y-axis label distance
# ax4.set_zlabel('Score', fontsize=18, labelpad=12)  # Adjust z-axis label distance
# ax4.set_zlim(0, 0.75)
...
plt.savefig('output/hyper_missing_rate.png', dpi=600, transparent=False)
